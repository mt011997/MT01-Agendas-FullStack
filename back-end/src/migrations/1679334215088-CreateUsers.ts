...
export class CreateUsers1679334215088 implements MigrationInterface {
    name = 'CreateUsers1679334215088'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "contacts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "full_name" character varying(130) NOT NULL, "email" character varying(50) NOT NULL, "phone" character varying(15) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "userIdId" uuid, CONSTRAINT "UQ_752866c5247ddd34fd05559537d" UNIQUE ("email"), CONSTRAINT "UQ_84cae51c485079bdd8cdf1d828f" UNIQUE ("phone"), CONSTRAINT "PK_b99cd40cfd66a99f1571f4f72e6" PRIMARY KEY ("id"))`);
